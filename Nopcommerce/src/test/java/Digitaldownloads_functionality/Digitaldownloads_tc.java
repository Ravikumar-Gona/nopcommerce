package Digitaldownloads_functionality;
...
public class Digitaldownloads_tc extends Baseclass {
	...
	public void te() throws InterruptedException {
		...
		click("//ul[@class='top-menu notmobile']/li[4]");
	
		
		WebElement title=driver.findElement(By.xpath("//h1[text()='Digital downloads']"));
			...
			for(WebElement li1:list1) {
				...
				Thread.sleep(2000);	
				  ...
				  JavascriptExecutor js = (JavascriptExecutor) driver;
				   ...
				   Thread.sleep(1000);	
				click("//h2[@class='product-title']//a[text()='Science & Faith']");
