...
public class Shoe extends Baseclass{
	...
	public void te() throws InterruptedException {
		...
		WebElement ele=driver.findElement(By.xpath("//ul[@class='top-menu notmobile']/li[3]/a"));
		action.moveToElement(ele).build().perform();
		
		click("//ul[@class='sublist first-level']//a[text()='Shoes ']");
		...
		for(WebElement li:list) {
			...
			List<WebElement> chboxes=driver.findElements(By.xpath("//ul[@class='group product-spec-group product-spec-color']/li/input"));
			System.out.println(chboxes.size());
			for(WebElement box:chboxes) {
				box.click();
				...
				Thread.sleep(2000);	
				  ...
				  JavascriptExecutor js = (JavascriptExecutor) driver;
				   ...
				   Thread.sleep(1000);	
				click("//a[text()='Nike SB Zoom Stefan Janoski \"Medium Mint\"']");
				
				click("//a[text()='2 review(s)']");
				Thread.sleep(2000);	
