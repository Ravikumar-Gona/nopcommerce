...
public class books_tc extends Baseclass {
	...
	public void te() throws InterruptedException {
		...
		click("//ul[@class='top-menu notmobile']/li[5]");
	
		
		WebElement title=driver.findElement(By.xpath("//h1[text()='Books']"));
			...
			for(WebElement li1:list1) {
				...
				Thread.sleep(2000);	
				  ...
				  JavascriptExecutor js = (JavascriptExecutor) driver;
				   ...
				   Thread.sleep(1000);	
				click("//a[text()='Pride and Prejudice']");
