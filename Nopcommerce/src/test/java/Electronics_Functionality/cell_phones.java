...
public class cell_phones extends Baseclass {
	...
	public void te() throws InterruptedException {
		...
		WebElement ele=driver.findElement(By.xpath("//ul[@class='top-menu notmobile']/li[2]/a"));
		action.moveToElement(ele).build().perform();
		
		click("//ul[@class='sublist first-level']//a[text()='Cell phones ']");
		
		WebElement title=driver.findElement(By.xpath("//div[@class='page-title']/h1"));
		if(title.equals("Cell phones")) {
			...
			for(WebElement li1:list1) {
				...
				Thread.sleep(2000);	
				  ...
				  JavascriptExecutor js = (JavascriptExecutor) driver;
				   ...
				   Thread.sleep(1000);	
				click("//a[text()='HTC One Mini Blue']");
				
				click("//a[text()='4 review(s)']");
				Thread.sleep(2000);	
