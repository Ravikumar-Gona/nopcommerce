...
public class camer_photo extends Baseclass {
	...
	public void te() throws InterruptedException {
		...
		WebElement ele=driver.findElement(By.xpath("//ul[@class='top-menu notmobile']/li[2]"));
		action.moveToElement(ele).build().perform();
		
		click("//ul[@class='sublist first-level']//a[text()='Camera & photo ']");
		
		WebElement title=driver.findElement(By.xpath("//h1[text()='Camera & photo']"));
		if(title.equals("Camera & photo")) {
